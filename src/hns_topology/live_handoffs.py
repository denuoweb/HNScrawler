...
def refresh_hns_handoff_groups(
    ...
    *,
    ...
    groups: list[tuple[str, str, str, str, int, str, str, str]] = []
...
def hns_handoff_group_rows(conn: sqlite3.Connection) -> list[dict[str, Any]]:
    rows = conn.execute(
        """
        SELECT nameserver, root_name, bootstrap_ip, bootstrap_field, member_count, members_json
