...
LIVE_HANDOFF_PREFLIGHT_CONCURRENCY="${LIVE_HANDOFF_PREFLIGHT_CONCURRENCY:-4}"
LIVE_HANDOFF_PREFLIGHT_MIN_DELAY_MS="${LIVE_HANDOFF_PREFLIGHT_MIN_DELAY_MS:-500}"
LIVE_HANDOFF_PREFLIGHT_TIMEOUT="${LIVE_HANDOFF_PREFLIGHT_TIMEOUT:-8}"
